...
func handleLocalOrder(order Buttonpress, lightUpdateChan <-chan [NumElevators]Elev, newOrderChan <-chan ButtonEvent, updateChan <-chan ButtonEvent,id int, ) {
	if order == order.BtnCab {
