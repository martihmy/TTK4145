The orderHandler is responsible for handling all orders for a local elevator based on information on it self and other elevators supplied by the sync module.
